-- V58: Add dew_point_celsius to forecast_evaluation for mist/fog potential scoring.
...
ALTER TABLE forecast_evaluation ADD COLUMN IF NOT EXISTS dew_point_celsius DOUBLE PRECISION;
