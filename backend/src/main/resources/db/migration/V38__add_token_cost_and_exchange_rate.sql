...
ALTER TABLE job_run ADD COLUMN exchange_rate_gbp_per_usd DOUBLE PRECISION;
...
ALTER TABLE model_test_run ADD COLUMN exchange_rate_gbp_per_usd DOUBLE PRECISION;

-- exchange_rate table: daily rate cache
CREATE TABLE exchange_rate (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    rate_date DATE NOT NULL UNIQUE,
    gbp_per_usd DOUBLE PRECISION NOT NULL,
