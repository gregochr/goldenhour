 ...
 * share a different one. The Postgres container is unaffected: it is a {@code static}
 * field on the parent, {@code start()} is a no-op once started, and Ryuk reaps it at JVM
 * exit — so one container per surefire fork regardless of how many contexts boot.
 */
