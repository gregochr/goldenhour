...
describe('PromptTestView', () => {
  ...
  it('shows git info badge', async () => {
    render(<PromptTestView />);
    await waitFor(() => {
      expect(screen.getByTestId('git-info-badge')).toBeInTheDocument();
    });
    expect(screen.getByTestId('git-info-badge').textContent).toContain('abc1234');
  });
  ...
  it('shows comparison checkboxes in run rows', async () => {
    getPromptTestRuns.mockResolvedValue({
      data: [
        { id: 1, startedAt: '2026-03-01T10:00:00', targetDate: '2026-03-01', targetType: 'SUNSET', evaluationModel: 'HAIKU', locationsCount: 2, succeeded: 2, failed: 0, durationMs: 5000 },
        { id: 2, startedAt: '2026-03-02T10:00:00', targetDate: '2026-03-02', targetType: 'SUNSET', evaluationModel: 'HAIKU', locationsCount: 2, succeeded: 2, failed: 0, durationMs: 5000 },
      ],
    });
  ...
  it('shows comparison panel when 2 runs are checked', async () => {
    getPromptTestRuns.mockResolvedValue({
      data: [
        { id: 1, startedAt: '2026-03-01T10:00:00', targetDate: '2026-03-01', targetType: 'SUNSET', evaluationModel: 'HAIKU', locationsCount: 2, succeeded: 2, failed: 0, durationMs: 5000, gitCommitHash: 'aaa1111', gitBranch: 'main', gitDirty: false },
        { id: 2, startedAt: '2026-03-02T10:00:00', targetDate: '2026-03-02', targetType: 'SUNSET', evaluationModel: 'HAIKU', locationsCount: 2, succeeded: 2, failed: 0, durationMs: 5000, gitCommitHash: 'bbb2222', gitBranch: 'main', gitDirty: false },
      ],
    });
