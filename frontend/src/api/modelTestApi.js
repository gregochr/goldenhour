...
export const runModelTest = () => {
  return apiClient.post('/api/model-test/run');
};
...
export const getModelTestRuns = () => {
  return apiClient.get('/api/model-test/runs');
};
...
export const runModelTestForLocation = (locationId) => {
  return apiClient.post(`/api/model-test/run-location?locationId=${locationId}`);
};
...
export const rerunModelTest = (testRunId) => {
  return apiClient.post(`/api/model-test/rerun?testRunId=${testRunId}`);
};
...
export const rerunModelTestDeterministic = (testRunId) => {
  return apiClient.post(`/api/model-test/rerun-determinism?testRunId=${testRunId}`);
};
...
export const getModelTestResults = (testRunId) => {
  return apiClient.get(`/api/model-test/results?testRunId=${testRunId}`);
};
