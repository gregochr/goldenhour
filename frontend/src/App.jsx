...
function AppInner() {
  ...
  const {
    ...
    session: healthSession, startedAt: healthStartedAt,
  } = useHealthStatus();
      ...
      <header className="border-b border-plex-border px-4 py-6">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex flex-col items-end gap-1">
            {isAdmin && <HealthIndicator status={healthStatus} degraded={healthDegraded} checkedAt={healthCheckedAt} build={healthBuild} services={healthServices} database={healthDatabase} session={healthSession} startedAt={healthStartedAt} />}
