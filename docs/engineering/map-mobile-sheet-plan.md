...
at `z-index: 9999` that blocks the map (`useOutsideDismiss.js` **73, 85–86, 110** records that the map
...
`#8FC0C7` has no token; `index.css` **3451** and **6008–6009** (rule at 6019–6021) record that the
