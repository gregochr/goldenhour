...
**Status: COMPLETE at M5's commit — M1–M4 are on `main`, M5 lands with this line. The flag flip is the owner's call and this series no longer blocks it; §11 states what it still waits on, and §11c is the list to read before flipping.** Written 2026-08-20 against the v3 design bundle at
