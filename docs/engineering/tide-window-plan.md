...
**Status: T1, T2, T3 and T6 BUILT; T4, T5, T7, T8 not started.** T6 was built in parallel with T4
and T5 (each in its own worktree, per §8) and touches no file either of those phases claims. T1's
